...
export default function Profile() {
  ...
  return (
    <div className="p-4 max-w-lg mx-auto font-semibold">
      <h1 className="text-4xl text-center font-bold my-11">Profile</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 ">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700 font-semibold">Error in image uploading (image must be less than 3mb)</span>
        ...
        <input
          ...
          onChange={handleChange}
        />
        <button disabled={loading} className="bg-zinc-950 text-white p-3 rounded-lg uppercase hover:opacity-80 disabled:opacity-60">
          {loading? 'Loading......' : 'Update'}
        </button>
        <Link className="bg-green-800 text-white p-3 text-center rounded-lg uppercase hover:opacity-80 disabled:opacity-60" to={"/create-Listing"}>Create Listing</Link>
      </form>
      ...
      <p className="text-red-700 mt-5">{showListingsError ? "Error in showing your listings" : ''}</p>


      {showListings &&
        showListings.length > 0 &&
        <div className="flex flex-col gap-4">
          <h1 className='text-center my-7 text-3xl font-semibold'>Your Property Listings</h1>
